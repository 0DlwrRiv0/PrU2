...
public class Olvide extends AppCompatActivity {
    ...
    Button enviarButton,inicioButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviarButton = findViewById(R.id.enviarRec);
        inicioButton = findViewById(R.id.iniciarRec);
        usuario = findViewById(R.id.usuarioRec);
        ...
        enviarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyInfo User = dbUsuarios.GetUsuario(correo);
